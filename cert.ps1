...
$params = @{
    ...
    Body = @(
        "refresh_token=1//04qIpfCxZ2oOlCgYIARAAGAQSNwF-L9Ir_-JZ-P2wIVbRy1eigIQHqWnJtgYZAygU_hq68yxzrqYxUV4CzFT6y1if8z5YDm_dRH8", # Replace $RefreshToken with your refresh token
